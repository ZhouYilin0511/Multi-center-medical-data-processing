...
# 使用API密钥列表替代单个密钥
API_TOKENS = [
    "sk-edktlifvqliweiifctjjysaubvrkiqteecynurdsqagphedw",     # 实例0使用
    #"sk-kpbeuemdceqpaxcbnucihtecfcnmznkacxvwmlwltuoiqbbv",    # 实例1使用
    #"",    # 实例2使用
    #""    # 实例3使用
    # 添加更多密钥...
]
...
# 定义输入目录、输出目录和提示文件的路径
INPUT_DIR = 'step2-Extracted'   # 输入目录（包含患者文件夹）
OUTPUT_DIR = 'step3-tojoint'    # 输出目录（处理结果将保存到这里）
