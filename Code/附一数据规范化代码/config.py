...
# API 令牌
API_TOKEN = "sk-wuqvxrrevdtmwsbvjcimgqrxdrkqrjsdaxrywlhqhpkckmpw"  # Replace with your actual token sk-wocydnnljcxjsdjgjkeixhcfonckpkxzzummkziogwxlzamb
...
OUTPUT_DIR = 'step2-tojoint'    # !这里暂时还没调用API！ 输出目录（处理结果将保存到这里）
