...
PROMPT_MAPPING = {
    ...
    "入院记录-中医四诊.txt": "入院记录-中医四诊提示词.txt",  # 入院记录-中医四诊提示词
    "入院记录-专科检查.txt": "入院记录-专科检查提示词.txt",  # 入院记录-专科检查提示词
    "入院记录-辅助检查项目.txt": "入院记录-辅助检查项目提示词.txt",  # 入院记录-辅助检查提示词
    "(合并)首程中西医诊断.txt": "首次病程-中西医诊断提示词.txt",  # 首次病程-中西医诊断提示词
    "首次病程记录-专科检查.txt": "首次病程-专科检查提示词.txt",  # 首次病程-专科检查提示词
    ...
    "(合并)出院记录诊断.txt": "出院记录-中西医诊断提示词.txt",  # 出院记录中西医诊断提示词
    ...
    "检查项.txt": "检查项提示词.txt",  # 检查项提示词
    "检验项.txt": "检验项提示词.txt",  # 检验项提示词
